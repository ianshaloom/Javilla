...
class FilterService extends GetxService {
  ...
  static FilterService init() {
    return Get.put(FilterService());
  }
  ...
  void setLastMonthFilter() {
    ...
    dateRange.value = DateTimeRange(start: startOfLastMonth, end: endOfLastMonth);
  ...
  Map<String, dynamic> get filterParams {
    ...
    if (filterType.value == 'today') {
      ...
      params['date'] = DateFormat('yyyy-MM-dd').format(selectedDate.value);
    } else if (filterType.value == 'this-date') {
      params['filterType'] = 'this-date';
      params['date'] = DateFormat('yyyy-MM-dd').format(selectedDate.value);
    } else {
      params['filterType'] = filterType.value;
      params['startDate'] = DateFormat('yyyy-MM-dd').format(dateRange.value!.start);
